...
public class FileUtils {
    ...
    public static boolean isAvaiableSpace(int sizeMb) {
        ...
        if (!TextUtils.isEmpty(BaseApplocation.getInstance().ROOT_PATH)) {
            String sdcard = BaseApplocation.getInstance().ROOT_PATH;// Environment.getExternalStorageDirectory().getPath();
